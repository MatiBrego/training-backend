...
-- AddForeignKey
ALTER TABLE "Retweet" ADD CONSTRAINT "Retweet_retweeterId_fkey" FOREIGN KEY ("retweeterId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
